...
public class TreTackFilter {
    ...
    public static Filter TACKSHOP_1;
    public static Filter TACKSHOP_2;
    public static Filter TACKSHOP_3;
    public static Filter TACKSHOP_4;
    public static Filter TACKSHOP_5;
    public static Filter TACKSHOP_6;
    public static Filter TACKSHOP_7;
    public static Filter TACKSHOP_8;
    public static Filter TACKSHOP_9;
    public static Filter TACKSHOP_10;
    public static Filter TACKSHOP_11;
    public static Filter TACKSHOP_12;
    public static Filter TACKSHOP_13;
    public static Filter TACKSHOP_14;
    ...
    public static void onClientSetup(FMLClientSetupEvent event) {
        event.enqueueWork(() -> {
            ...
            TACKSHOP_1 = FilterBuilder.registerFilter(
                    TackShopCreativeModTab.MAIN.get(),
                    Component.translatable("filter.tretackshop.tackshop_1"),
                    () -> new ItemStack(TackShopItems.DYES.get(0).get())
            );
            TACKSHOP_2 = FilterBuilder.registerFilter(
                    TackShopCreativeModTab.MAIN.get(),
                    Component.translatable("filter.tretackshop.tackshop_2"),
                    () -> new ItemStack(TackShopItems.DYES.get(1).get())
            );
            TACKSHOP_3 = FilterBuilder.registerFilter(
                    TackShopCreativeModTab.MAIN.get(),
                    Component.translatable("filter.tretackshop.tackshop_3"),
                    () -> new ItemStack(TackShopItems.DYES.get(2).get())
            );
            TACKSHOP_4 = FilterBuilder.registerFilter(
                    TackShopCreativeModTab.MAIN.get(),
                    Component.translatable("filter.tretackshop.tackshop_4"),
                    () -> new ItemStack(TackShopItems.DYES.get(3).get())
            );
            TACKSHOP_5 = FilterBuilder.registerFilter(
                    TackShopCreativeModTab.MAIN.get(),
                    Component.translatable("filter.tretackshop.tackshop_5"),
                    () -> new ItemStack(TackShopItems.DYES.get(4).get())
            );
            TACKSHOP_6 = FilterBuilder.registerFilter(
                    TackShopCreativeModTab.MAIN.get(),
                    Component.translatable("filter.tretackshop.tackshop_6"),
                    () -> new ItemStack(TackShopItems.DYES.get(5).get())
            );
            TACKSHOP_7 = FilterBuilder.registerFilter(
                    TackShopCreativeModTab.MAIN.get(),
                    Component.translatable("filter.tretackshop.tackshop_7"),
                    () -> new ItemStack(TackShopItems.DYES.get(6).get())
            );
            TACKSHOP_8 = FilterBuilder.registerFilter(
                    TackShopCreativeModTab.MAIN.get(),
                    Component.translatable("filter.tretackshop.tackshop_8"),
                    () -> new ItemStack(TackShopItems.DYES.get(7).get())
            );
            TACKSHOP_9 = FilterBuilder.registerFilter(
                    TackShopCreativeModTab.MAIN.get(),
                    Component.translatable("filter.tretackshop.tackshop_9"),
                    () -> new ItemStack(TackShopItems.DYES.get(8).get())
            );
            TACKSHOP_10 = FilterBuilder.registerFilter(
                    TackShopCreativeModTab.MAIN.get(),
                    Component.translatable("filter.tretackshop.tackshop_10"),
                    () -> new ItemStack(TackShopItems.DYES.get(9).get())
            );
            TACKSHOP_11 = FilterBuilder.registerFilter(
                    TackShopCreativeModTab.MAIN.get(),
                    Component.translatable("filter.tretackshop.tackshop_11"),
                    () -> new ItemStack(TackShopItems.DYES.get(10).get())
            );
            TACKSHOP_12 = FilterBuilder.registerFilter(
                    TackShopCreativeModTab.MAIN.get(),
                    Component.translatable("filter.tretackshop.tackshop_12"),
                    () -> new ItemStack(TackShopItems.DYES.get(11).get())
            );
            TACKSHOP_13 = FilterBuilder.registerFilter(
                    TackShopCreativeModTab.MAIN.get(),
                    Component.translatable("filter.tretackshop.tackshop_13"),
                    () -> new ItemStack(TackShopItems.DYES.get(12).get())
            );
            TACKSHOP_14 = FilterBuilder.registerFilter(
                    TackShopCreativeModTab.MAIN.get(),
                    Component.translatable("filter.tretackshop.tackshop_14"),
                    () -> new ItemStack(TackShopItems.DYES.get(13).get())
            );
            ...
            TackShopItems.REGISTRY.getEntries().forEach(entry -> {
                        ...
                        if (
                            ...
                            TACKSHOP_10.addItems(entry.get());
                        }
                        if (
                            ...
                            TACKSHOP_11.addItems(entry.get());
                        }
                        if (
                            ...
                            TACKSHOP_12.addItems(entry.get());
                        }
                        if (
                            ...
                            TACKSHOP_13.addItems(entry.get());
                        }
                        if (
                            ...
                            TACKSHOP_14.addItems(entry.get());
                        }
            ...
            AwardShopItems.REGISTRY.getEntries().forEach(entry -> {
                    String name = entry.getId().getPath();
                if (
                        name.matches(".*_1(_armored)?$") &&
                                name.contains("award")
